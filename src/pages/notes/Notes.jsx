    ...
    return (
        <div className="w-[85%] ml-auto bg-yellow-400">
            ...
            <div className="w-full p-10 rounded-tl-lg bg-white">
                <h2 className="text-2xl font-bold text-slate-800 underline">/Notes</h2>
                ...
                <div className="grid grid-cols-4 gap-5">
                    <CourseCard type={6} name={"Mathematiques"} />
                    <CourseCard name={"Histoire"} />
                    <CourseCard type={1} name={"Informatique"} />
                    <CourseCard type={2} name={"Anglais"} />
                    <CourseCard type={3} name={"SVT"} />
                    <CourseCard type={4} name={"Geographie"} />
                    <CourseCard type={5} name={"ECM"}/>
                    <CourseCard type={6} name={"Physique"} />
                    <CourseCard type={7} name={"Chimie"} />
                </div>
            </div>
        </div>
    )
...
function CourseCard ({type=0, name}) {
    ...
    return (
        <Link to="/notes_list" className="block relative w-full h-auto rounded-lg bg-white shadow-xl cursor-pointer" onMouseEnter={() => {control.start({opacity: 0.7, scale: 1})}} onMouseLeave={() => {control.start({opacity: 0, scale: 0.5})}}>
            ...
            <div className="p-2">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <p className="text-sm text-slate-400">Sequence 3</p>
                </div>
            </div>
        </Link>
    )
