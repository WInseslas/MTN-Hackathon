...
export default function CourseFlux () {
    return (
...
function MainPanel() {
    return (
        <div className="w-[75%] py-5">
            <div className="w-full px-3 py-2 mb-5 flex items-center border-[1px] border-slate-300 rounded-lg shadow-md">
                <div className="w-[10%]">
        ...
        <div className="w-full h-auto">
            <div className="w-full border-[1px] border-gray-300 rounded-lg mt-2 py-2 px-3">
                <div className="w-full border-b-[1px] border-gray-300">
                    ...
                    <div className="mt-2 mb-3 mt-5 text-sm text-gray-800">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minus ut architecto quaerat vero impedit labore consequatur atque omnis praesentium</div>
                </div>
        ...
        <div className="w-[23%] py-5">
            <div className="w-full mx-auto border-2 border-slate-200 rounded-md pt-2">
                ...
                <div className="w-full flex justify-end p-2">
                    <button className="w-full py-2 px-2 ml-auto bg-yellow-400 rounded-lg">Tout afficher</button>
                </div>
            </div>
            <div className="w-full mt-3">
                <h4 className="text-lg mb-3">Annonces</h4>
                <div className="w-full h-auto mb-2 px-2 py-3 bg-slate-200 rounded-lg">
                    <p>Notes disponibles</p>
                </div>
                <div className="w-full h-auto mb-2 px-2 py-3 bg-slate-200 rounded-lg">
                    <p>Nouvelle evaluation</p>
                </div>
            </div>
        </div>
    )
