...
export default function TeacherCoursesCreatePage () {
    return (
        <div>
            {/* <SideBarTeacher type={2} /> */}
            <Container />
        </div>
    )
}
        ...
        <div className="w-[100%] ml-auto bg-yellow-400">
            ...
            <div className="w-full bg-slate-100 rounded-tl-lg pt-5 px-10">
                <div className="w-full h-[80px] mb-5 bg-violet-600 p-5 rounded-lg shadow-xl">
                    ...
                    <p className="text-white text-sm">Nouveau cours</p>
                </div>
...
function MainPanel () {
    ...
    return (
        <div className="w-[75%] h-full pb-5 flex flex-col justify-start items-start overflow-auto">
            ...
            <div className="border-[1px] border-slate-300 p-5 rounded-lg bg-white">
...
function RightPanel () {
    ...
    return (
        <div className="w-[23%] h-full">
            <div className="py-5 px-5 border-[1px] border-slate-300 rounded-lg bg-white mb-3">
                <h4 className="text-lg font-medium mb-5">Informations</h4>
                <div className="mb-5">
                    <p className="mb-2">Chapter :</p>
                    <TextField id="filled-basic" label="" variant="filled" className="w-full bg-white" />
                </div>
            </div>
            <div className="py-5 px-5 border-[1px] border-slate-300 rounded-lg bg-white mb-3">
                <h4 className="text-lg font-medium mb-5">Programmer</h4>
                <div className="mb-5">
                    <p className="mb-2">Date :</p>
                    <TextField type="date" id="filled-basic" label="" variant="filled" className="w-full bg-white" />
                </div>
                <div>
                    <p className="mb-2">Heure :</p>
                    <TextField type="time" id="filled-basic" label="" variant="filled" className="w-full bg-white" />
                </div>
            </div>
            <div>
