    ...
    return (
        <div className="w-[85%] ml-auto bg-yellow-400">
            ...
            <div className="w-full p-10 rounded-tl-lg bg-white">
                <h2 className="text-2xl font-bold text-slate-800 underline mb-5">/Evaluation</h2>
                <div className="w-full py-5">
                    <ExamInformations />
                    <ExamSubject />
                    <h1 className="text-2xl font-bold text-center mb-5">Answers of the questions</h1>
...
function ExamSubject () {
    return (
        <div className="px-5 mb-5">
            <h1 className="text-3xl font-bold text-center">Exam 1st Sequence</h1>
            <div className="mb-5">
