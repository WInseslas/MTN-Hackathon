...
export default function TeacherEvaluationCreateQuestionnairePage () {
    return (
        <div>
            <Container />
        </div>
        ...
        <div className="w-[100%] ml-auto bg-yellow-400">
            ...
            <div className="w-full bg-slate-100 rounded-tl-lg pt-5 px-10">
                <div className="w-full h-[80px] mb-5 bg-violet-600 p-5 rounded-lg shadow-xl">
                    <h4 className="text-2xl font-bold text-white">SCIENCE DE LA DE LA TERRE</h4>
                    <p className="text-white text-sm">Nouveau questionnaire</p>
                </div>
            ...
            <div className="border-2 border-slate-300 p-5 rounded-lg bg-white">
                <div className="grid grid-cols-2 gap-5">
                    ...
                    <FormControl variant="filled" className="w-full">
                        ...
                        <MenuItem value={10}>Reponse courte</MenuItem>
                        <MenuItem value={20}>Choix multiple</MenuItem>
                        </Select>
                    </FormControl>
                </div>
