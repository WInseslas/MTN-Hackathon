...
export default function CourseNotDone () {
    return (
...
function CourseCard () {
    return (
        <Link to="/course_video" className="block w-full mb-3 bg-slate-200 rounded-xl flex cursor-pointer">
            <div className="h-[70px] w-[50px] mr-3 bg-violet-500 dark-shadow-r rounded-xl"></div>
            <div className="w-full py-2 pr-5">
                <h4 className="text-lg font-medium">CHAPITRE 3: Les animaux Invertébrés</h4>
