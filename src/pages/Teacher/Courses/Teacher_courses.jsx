    ...
    return (
        <div className="w-[85%] ml-auto bg-yellow-400">
            ...
            <div className="w-full p-10 rounded-tl-lg bg-white">
                <h2 className="text-2xl font-bold text-slate-800 mb-5">/Courses</h2>
...
function CourseCard ({type=0}) {
    ...
    return (
        <Link to="/teacher_courses_details" className="block relative w-full h-auto rounded-lg bg-white shadow-xl cursor-pointer" onMouseEnter={() => {control.start({opacity: 0.7, scale: 1})}} onMouseLeave={() => {control.start({opacity: 0, scale: 0.5})}}>
            ...
            <div className="p-2">
                <h3 className="text-sm text-slate-700">Tle C</h3>
                <h5 className="text-xl font-medium mb-3">Informatique</h5>
